class postfix (
  ...
  Boolean $enable_server_ssl,
	...
	String  $smtpd_tls_key_file,
	String  $smtpd_use_tls,
	String  $smtpd_tls_session_cache_database,
	String  $smtp_tls_session_cache_database,
	String  $smtpd_tls_loglevel,
	String  $smtpd_tls_security_level,
	String  $smtpd_tls_received_header,
	String  $smtpd_tls_session_cache_timeout,
	String  $smtpd_tls_mandatory_protocols,
	String  $smtp_tls_mandatory_protocols,
	String  $smtpd_tls_protocols,
	String  $smtp_tls_protocols,
	String  $smtpd_tls_ciphers,
	String  $smtp_tls_mandatory_ciphers,
	String  $smtp_tls_mandatory_exclude_ciphers,
	String  $smtp_tls_exclude_ciphers,

  Boolean $enable_client_ssl,
	String  $smtp_use_tls,
	String  $smtp_tls_note_starttls_offer,
	String  $smtp_tls_loglevel,
